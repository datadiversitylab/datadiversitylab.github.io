...
// available from here.
(function () {
    var iframe = document.getElementById('salphycon-iframe');
    var fallback = document.getElementById('salphycon-fallback');
...
(function () {
    var wrapper = document.getElementById('salphycon-frame-wrapper');
    var fsBtn = document.getElementById('salphycon-fullscreen-btn');
